$(document).ready(function () {
  ...
  $("#botao").click(function () {
    ...
    if (
      ...
      document.getElementById("nombre").innerHTML = "Nombre: " + nome;

      document.getElementById("data").innerHTML = "Edad: " + data;
  ...
  /*function downloadPDF() {
    ...
    var opt = {
      margin: 1,
      filename: "estiloaprendizaje.pdf",
  ...
  $("#descarga").click(function () {
    //const item = document.getElementById("resultado-descricao");

    const item = document.querySelector("#box");

    const opt = {
      margin: 1,
      filename: "estilo-aprendizaje.pdf",
      image: { type: "jpeg", quality: 0.98 },
      html2canvas: { scale: 2 },
      jsPDF: { unit: "in", format: "letter", orientation: "portrait" },
    };
